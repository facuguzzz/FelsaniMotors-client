...
const UsuarioActualizacion = ({ changeActualizacionVisible }) => {
  ...
  const URLModificarUsuario = `http://localhost:4002/api/usuarios/${user?.id}`;
    ...
    <div className="bg-[#f5efe6] min-h-screen flex justify-center items-start py-10">
      ...
      >
        ...
        <div className="flex justify-between mt-8">
          <button
            type="button"
            onClick={changeActualizacionVisible}
